...
class PermissionRemove extends Command
{
     ...
     * @var string
     */
    protected $signature = 'permission:rm {user : email of the user} {permission : Permission ID to remove}';
     ...
     * @var string
     */
    protected $description = 'Remove permission from a user';
    ...
    public function handle()
    {
        ...
        \Models\Business\User::get($user->user_id)->removePermission($permission);
    }
}
