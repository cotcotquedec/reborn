...
<head>
    <meta charset="utf-8"/>
    <title>Authentification - Alliwant</title>
...
<div class="content">
    <!-- BEGIN LOGIN FORM -->
    <h3 class="form-title text-center">Bienvenue sur Reborn</h3>

    <div class="text-center">
        <a href="{{ route('login-with-fb') }}" class="btn btn-lg btn-primary"><i class="fa fa-facebook"></i> Connexion</a>
    </div>
    <!-- END LOGIN FORM -->
</div>
<!-- END LOGIN -->
